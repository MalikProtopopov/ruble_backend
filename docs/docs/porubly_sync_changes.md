...
> **Актуализация (март 2026):** ниже — история правок. Текущий канон: благодарности — `GET /api/v1/thanks/{id}` и `GET /api/v1/thanks/unseen` ([api_public.md](api_public.md)); очистка `thanks_content_shown` — **12 месяцев**, 1-е число 03:00 UTC ([database_requirements.md](database_requirements.md), ФТ §4.14 TASK-07); ЮKassa — [yookassa_integration.md](yookassa_integration.md).
